...
配音秀 unlock vip by 渤涵

[rewrite_local]
^http:\/\/api\.peiyinxiu\.com\/(Api\/User\/GetTools|Api\/User\/SetTool|Api\/user\/GetMyInfo) url script-response-body buehen0426/Scripts/pyx/pyx.js

[MITM]
hostname:api1.peiyinxiu.xom
